    ...
    def execute(self, video_id):
        ...
        if existing_emotions:
            ...
            for idx, frame in enumerate(frames):
                annotations, annotated_frame_path, frame_data = self.emotion_service.detect_emotions_in_frame(
                    frame.path)
                ...
                frame.average_brightness = frame_data['average_brightness']
                frame.contrast_ratio = frame_data['contrast_ratio']
                frame.sharpness = frame_data['sharpness']
                frame.color_temperature = frame_data['color_temperature']
                frame.background_complexity = frame_data['background_complexity']

                db.session.add(frame)  # Mark frame as modified
                ...
                for annotation in annotations:
                    ...
                    person.age_estimation = annotation['age_estimation']
            ...
            output_video_path = self.video_generation_service.generate_video_from_frames(
                annotated_frames, output_video_filename
            )
